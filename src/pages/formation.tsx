            ...
            <div class="relative max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center z-10">
                ...
                <div class="text-white space-y-6">
                    ...
                    <div class="flex flex-wrap gap-4 pt-4">
                        <a href="https://cembymazini.ma/static/Catalogue%20de%20formations%20CEM%202026_compressed.pdf" download class="bg-gradient-to-r from-[#D4AF37] to-[#FFD700] text-black px-8 py-4 rounded-full font-bold text-lg hover:shadow-xl hover:shadow-[#D4AF37]/50 transition-all inline-flex items-center">
        ...
        <section class="py-20 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-gradient-to-r from-[#D4AF37] to-[#FFD700] rounded-3xl p-12 text-center text-white">
                    ...
                    <a href="https://cembymazini.ma/static/Catalogue%20de%20formations%20CEM%202026_compressed.pdf" download 
                ...
                <div class="mt-16 text-center">
                    <div class="bg-gradient-to-r from-[#D4AF37] to-[#FFD700] rounded-2xl p-8 inline-block">
                        ...
                        <div class="flex flex-wrap justify-center gap-4">
                            ...
                            <a href="https://cembymazini.ma/static/Catalogue%20de%20formations%20CEM%202026_compressed.pdf" download class="bg-white text-black px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-100 transition shadow-xl inline-flex items-center">
                                <i class="fas fa-download mr-2"></i>
                                Télécharger le catalogue
                            </a>
                        </div>
